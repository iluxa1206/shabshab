...
- [ ] Ещё аналитика: тепловая карта рейтинг×дюрация, скрин по carry/Y-IDX, экспорт CSV. Точная историч. динамика (forward daily snapshot spread_daily) — если нужна точность vs текущая оценка.
