"""Скринер-фильтры Telegram-бота: хранение (tg_filters/tg_filter_hits),
анти-спам и доставка в чат. Условия фильтра и прогон по рынку — общие с
вкладкой СИГНАЛЫ, живут в services/screener_core.py.

Цикл гоняет api.main.tg_screener_worker в торговые часы. Анти-спам:
(filter_id, isin) уходит в чат не чаще cooldown_min фильтра."""
import json
import logging
