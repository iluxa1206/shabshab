...
describe("правило цены старше put_date", () => {
  it("флоатеру с preferred_horizon=maturity оферта не подставляется", () => {
    // страховка на будущее: появись у строки флоатера поле put_date,
    // безусловная проверка вернула бы оферту бумаге, которую рынок прайсит к
    // погашению — и «срок» разошёлся бы с синей цифрой в таблице
    expect(horizonDate({ preferred_horizon: "maturity", put_date: "2027-01-01",
                         maturity_date: "2033-01-01" })).toBe("2033-01-01");
  });
});
