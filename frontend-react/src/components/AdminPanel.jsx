...
const _OPTS = {
  ...
  // point и avg_prev убраны: точечный фиксинг = average + окно 1;
  // среднее предыдущего периода = average + окно = купонный период
  coupon_mode: ["average", "month_start"],
  ...
  // ЛИНКЕР: по этому индексу растёт НОМИНАЛ, ставка купона фиксирована.
  // Пусто = обычная бумага (селект отдаёт пустой вариант первым).
  face_index: ["", "RUONIA"],
};
...
const _FIELDS = [
  ...
  ["face_index", "Индекс НОМИНАЛА (линкер: купон фиксирован, растёт номинал)", "text"],
];
