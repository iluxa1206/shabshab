...
export default function KpisInline({ bonds }) {
  ...
  return (
    <>
      ...
      {cell("MED spread", k.medYi, "медианный spread (IRR − роллирование RUONIA), б.п.")}
      {cell("AVG spread", k.avgYi, "средний spread (IRR − роллирование RUONIA), б.п.")}
      {cell("P25–P75", k.hasYi ? `${k.yiP25}–${k.yiP75}` : null, "межквартильный разброс spread, б.п.", "sec")}
