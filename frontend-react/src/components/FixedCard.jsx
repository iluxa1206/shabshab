    ...
    <>
      {r.linked && (
        <div className="linker-badge">
          <b>Линкер — индексируемый номинал.</b> Номинал привязан к базе (RUONIA / золото /
          инфляция), сейчас {fmt.num(r.face, 0)} ₽. Купон {fmt.pct(r.coupon_pct)}% начисляется
          на индексированный номинал, поэтому <b>YTM = реальная доходность</b> — спред над базой
          индексации (аналог маржи флоатера). Цена — % от индекс. номинала.
        </div>
      )}
